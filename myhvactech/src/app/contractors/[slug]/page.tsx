...
import type { Contractor, Review, ContractorPhoto, SampleProject } from '@/lib/types'
...
export default async function ContractorProfilePage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    aggregateRating: {
      ...
      ratingValue: contractor.avg_rating.toString(),
      reviewCount: contractor.review_count.toString(),
    },
